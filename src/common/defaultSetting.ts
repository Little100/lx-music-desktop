...
const defaultSetting: LX.AppSetting = {
  ...
  'player.audioVisualization.fftSize': 2048,
  'player.audioVisualization.smoothing': 80,
  'player.audioVisualization.heightScale': 70,
  'player.audioVisualization.opacity': 30,
  ...
  'player.audioVisualization.targetFps': 60,
